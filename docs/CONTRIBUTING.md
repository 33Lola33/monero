...
The "MyNewCoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- moneromooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to MyNewCoin code or MyNewCoin's dependency code or MyNewCoin's potential/future dependency code or research which successfully implements MyNewCoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the MyNewCoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the MyNewCoin Maintainer Team.
