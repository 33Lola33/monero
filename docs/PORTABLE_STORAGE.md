...
MyNewCoin makes use of a set of helper classes from a small library named
...
```json
{
  ...
  "long_quote": "MyNewCoin is more than just a technology. It's also what the technology stands for.",
...
4d 6f 6e 65 72 6f 20 69 73 20 6d 6f 72 65 20 74 // STRING value ("MyNewCoin is more t")
...
#### Links to some MyNewCoin struct definitions
