# Anonymity Networks with MyNewCoin

Currently only Tor and I2P have been integrated into MyNewCoin. The usage of
...
system clock is fairly accurate - many peers on the MyNewCoin network should have
similar timestamps.
...
### Intermittent MyNewCoin Syncing
