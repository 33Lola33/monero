...
# Copyright (c) 2022-2024 The MyNewCoin Project
...
# target, so we don't spend time building MyNewCoin binaries.
...
(
    ...
    # Setup the directory where our MyNewCoin build for HOST will be
